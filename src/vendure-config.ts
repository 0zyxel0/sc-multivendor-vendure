import {
  ...
  const IS_ORDER_INVENTORY_APPROVAL_ENABLED = process.env.ENABLE_ORDER_INVENTORY_APPROVAL === 'true';
    ...
    plugins: [    
      ...
      EmailPlugin.init({
        ...
        globalTemplateVars: {
          ...
          fromAddress: '"Marketplace Notification" <no-reply-order-notification@scribblecubes.ph>',
          ...
          changeEmailAddressUrl: 'https://marketplace.scribblecubes.ph/verify-email-address-change',
        },
      }),
      AdminUiPlugin.init({
        route: 'admin',
      ...
      ...(IS_ORDER_INVENTORY_APPROVAL_ENABLED ? [OrderInventoryApprovalPlugin.init({})] : []),
